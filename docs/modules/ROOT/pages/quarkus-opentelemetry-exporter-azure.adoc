...
You then can set the connection string:
...
You can also set the connection string with the standard Azure Application Insights way that takes precedence over the previous configuration:
